...
pub struct HkpVelocityConstraintMotor<'a> {
    ...
    /// `"hkpVelocityConstraintMotor"`: Name of this class.
...
impl HkpVelocityConstraintMotor<'_> {
    /// Return `"hkpVelocityConstraintMotor"`, which is the name of this class.
    ///
    /// # NOTE
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("tau" => Tau(f64)),
    ("velocityTarget" => VelocityTarget(f64)),
    ("useVelocityTargetFromConstraintTargets" => UseVelocityTargetFromConstraintTargets(bool)),
}
