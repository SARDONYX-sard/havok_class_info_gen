//! A Rust structure that implements a serializer/deserializer corresponding to `hkbEventDrivenModifierInternalState`, a class defined in C++
//!
//! # NOTE
...
pub struct HkbEventDrivenModifierInternalState<'a> {
    ...
    /// `0xd14bf000`: Unique value of this class.
    #[serde(default = "HkbEventDrivenModifierInternalState::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkbEventDrivenModifierInternalStateHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkbEventDrivenModifierInternalStateHkParam<'a>>
}
