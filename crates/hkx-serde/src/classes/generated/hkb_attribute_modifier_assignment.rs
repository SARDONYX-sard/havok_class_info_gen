//! A Rust structure that implements a serializer/deserializer corresponding to `hkbAttributeModifierAssignment`, a class defined in C++
//!
//! # NOTE
...
pub struct HkbAttributeModifierAssignment<'a> {
    ...
    /// `0x48b8ad52`: Unique value of this class.
    #[serde(default = "HkbAttributeModifierAssignment::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkbAttributeModifierAssignmentHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkbAttributeModifierAssignmentHkParam<'a>>
}
