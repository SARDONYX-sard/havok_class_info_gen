...
pub struct HkxAnimatedVector<'a> {
    ...
    /// `"hkxAnimatedVector"`: Name of this class.
...
impl HkxAnimatedVector<'_> {
    /// Return `"hkxAnimatedVector"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkxAnimatedVectorHkParam<'a> {
    ...
    Vectors(Vec<cgmath::Vector4<f32>>),
    /// # Information on fields in the original C++ class
    /// -   name:`"hint"`
    /// -   type: `enum Hint`
    /// - offset: 20
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("vectors" => Vectors(Vec<cgmath::Vector4<f32>>)),
    ("hint" => Hint(Hint)),
}
