//! A Rust structure that implements a serializer/deserializer corresponding to `hkpConstraintInstanceSmallArraySerializeOverrideType`, a class defined in C++
//!
//! # NOTE
...
pub struct HkpConstraintInstanceSmallArraySerializeOverrideType<'a> {
    ...
    #[serde(default = "HkpConstraintInstanceSmallArraySerializeOverrideType::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkpConstraintInstanceSmallArraySerializeOverrideTypeHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkpConstraintInstanceSmallArraySerializeOverrideTypeHkParam<'a>>
}
