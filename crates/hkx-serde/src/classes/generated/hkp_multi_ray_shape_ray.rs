...
pub struct HkpMultiRayShapeRay<'a> {
    ...
    /// `"hkpMultiRayShapeRay"`: Name of this class.
...
impl HkpMultiRayShapeRay<'_> {
    /// Return `"hkpMultiRayShapeRay"`, which is the name of this class.
    ///
    /// # NOTE
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("start" => Start(cgmath::Vector4<f32>)),
    ("end" => End(cgmath::Vector4<f32>)),
}
