...
pub struct HkpCenterOfMassChangerModifierConstraintAtom<'a> {
    ...
    /// `"hkpCenterOfMassChangerModifierConstraintAtom"`: Name of this class.
...
impl HkpCenterOfMassChangerModifierConstraintAtom<'_> {
    /// Return `"hkpCenterOfMassChangerModifierConstraintAtom"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkpCenterOfMassChangerModifierConstraintAtomHkParam<'a> {
    ...
    DisplacementA(cgmath::Vector4<f32>),
    /// # Information on fields in the original C++ class
    /// -   name:`"displacementB"`
    /// -   type: `hkVector4`
    /// - offset: 48
    ...
    DisplacementB(cgmath::Vector4<f32>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("displacementA" => DisplacementA(cgmath::Vector4<f32>)),
    ("displacementB" => DisplacementB(cgmath::Vector4<f32>)),
}
