//! A Rust structure that implements a serializer/deserializer corresponding to `BSPassByTargetTriggerModifier`, a class defined in C++
//!
//! # NOTE
...
pub struct BsPassByTargetTriggerModifier<'a> {
    ...
    /// `0x703d7b66`: Unique value of this class.
    #[serde(default = "BsPassByTargetTriggerModifier::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<BsPassByTargetTriggerModifierHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<BsPassByTargetTriggerModifierHkParam<'a>>
}
