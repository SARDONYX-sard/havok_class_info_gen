//! A Rust structure that implements a serializer/deserializer corresponding to `hkxEnvironmentVariable`, a class defined in C++
//!
//! # NOTE
...
pub struct HkxEnvironmentVariable<'a> {
    ...
    /// `0xa6815115`: Unique value of this class.
    #[serde(default = "HkxEnvironmentVariable::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkxEnvironmentVariableHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkxEnvironmentVariableHkParam<'a>>
}
