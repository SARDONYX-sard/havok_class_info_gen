//! A Rust structure that implements a serializer/deserializer corresponding to `hkpHingeLimitsData`, a class defined in C++
//!
//! # NOTE
...
pub struct HkpHingeLimitsData<'a> {
    ...
    /// `0xbd46760a`: Unique value of this class.
    #[serde(default = "HkpHingeLimitsData::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkpHingeLimitsDataHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkpHingeLimitsDataHkParam<'a>>
}
...
impl_deserialize_for_internally_tagged_enum! {
    HkpHingeLimitsDataHkParam<'de>, "@name",
