...
pub struct HkpVehicleManager<'a> {
    ...
    /// `"hkpVehicleManager"`: Name of this class.
...
impl HkpVehicleManager<'_> {
    /// Return `"hkpVehicleManager"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkpVehicleManagerHkParam<'a> {
    ...
    RegisteredVehicles(Vec<Box<HkpVehicleInstance>>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("registeredVehicles" => RegisteredVehicles(Vec<Box<HkpVehicleInstance>>)),
}
