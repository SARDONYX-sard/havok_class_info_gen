//! A Rust structure that implements a serializer/deserializer corresponding to `hkaSplineCompressedAnimationAnimationCompressionParams`, a class defined in C++
//!
//! # NOTE
...
pub struct HkaSplineCompressedAnimationAnimationCompressionParams<'a> {
    ...
    /// `0xde830789`: Unique value of this class.
    #[serde(default = "HkaSplineCompressedAnimationAnimationCompressionParams::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkaSplineCompressedAnimationAnimationCompressionParamsHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkaSplineCompressedAnimationAnimationCompressionParamsHkParam<'a>>
}
