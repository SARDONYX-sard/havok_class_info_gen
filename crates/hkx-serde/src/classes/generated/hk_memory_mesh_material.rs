//! A Rust structure that implements a serializer/deserializer corresponding to `hkMemoryMeshMaterial`, a class defined in C++
//!
//! # NOTE
...
/// -    size: 24
/// -  vtable: true
/// -  parent: hkMeshMaterial/`da8c7d7d`(Non prefix hex signature)
/// - version: 0
...
pub struct HkMemoryMeshMaterial<'a> {
    ...
    /// `0x12156ee3`: Unique value of this class.
    #[serde(default = "HkMemoryMeshMaterial::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkMemoryMeshMaterialHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkMemoryMeshMaterialHkParam<'a>>
}
