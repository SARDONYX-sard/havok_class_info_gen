...
pub struct HkpConstraintChainInstanceAction<'a> {
    ...
    /// `"hkpConstraintChainInstanceAction"`: Name of this class.
...
impl HkpConstraintChainInstanceAction<'_> {
    /// Return `"hkpConstraintChainInstanceAction"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkpConstraintChainInstanceActionHkParam<'a> {
    ...
    ConstraintInstance(Box<HkpConstraintChainInstance>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("constraintInstance" => ConstraintInstance(Box<HkpConstraintChainInstance>)),
}
