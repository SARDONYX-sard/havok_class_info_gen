//! A Rust structure that implements a serializer/deserializer corresponding to `hkaDeltaCompressedAnimationQuantizationFormat`, a class defined in C++
//!
//! # NOTE
...
pub struct HkaDeltaCompressedAnimationQuantizationFormat<'a> {
    ...
    #[serde(default = "HkaDeltaCompressedAnimationQuantizationFormat::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkaDeltaCompressedAnimationQuantizationFormatHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkaDeltaCompressedAnimationQuantizationFormatHkParam<'a>>
}
