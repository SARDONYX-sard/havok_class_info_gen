//! A Rust structure that implements a serializer/deserializer corresponding to `hkpPointToPlaneConstraintDataAtoms`, a class defined in C++
//!
//! # NOTE
...
pub struct HkpPointToPlaneConstraintDataAtoms<'a> {
    ...
    /// `0x749bc260`: Unique value of this class.
    #[serde(default = "HkpPointToPlaneConstraintDataAtoms::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkpPointToPlaneConstraintDataAtomsHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkpPointToPlaneConstraintDataAtomsHkParam<'a>>
}
...
impl_deserialize_for_internally_tagged_enum! {
    HkpPointToPlaneConstraintDataAtomsHkParam<'de>, "@name",
