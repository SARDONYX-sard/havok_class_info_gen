//! A Rust structure that implements a serializer/deserializer corresponding to `hkpTriggerVolumeEventInfo`, a class defined in C++
//!
//! # NOTE
...
pub struct HkpTriggerVolumeEventInfo<'a> {
    ...
    /// `0xeb60f431`: Unique value of this class.
    #[serde(default = "HkpTriggerVolumeEventInfo::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkpTriggerVolumeEventInfoHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkpTriggerVolumeEventInfoHkParam<'a>>
}
