...
pub struct HkxTriangleSelectionChannel<'a> {
    ...
    /// `"hkxTriangleSelectionChannel"`: Name of this class.
...
impl HkxTriangleSelectionChannel<'_> {
    /// Return `"hkxTriangleSelectionChannel"`, which is the name of this class.
    ///
    /// # NOTE
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("selectedTriangles" => SelectedTriangles(Vec<i32>)),
}
