...
pub struct HkpDisableEntityCollisionFilter<'a> {
    ...
    /// `"hkpDisableEntityCollisionFilter"`: Name of this class.
...
impl HkpDisableEntityCollisionFilter<'_> {
    /// Return `"hkpDisableEntityCollisionFilter"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkpDisableEntityCollisionFilterHkParam<'a> {
    ...
    DisabledEntities(Vec<Box<HkpEntity>>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("disabledEntities" => DisabledEntities(Vec<Box<HkpEntity>>)),
}
