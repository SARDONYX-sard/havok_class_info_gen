//! A Rust structure that implements a serializer/deserializer corresponding to `hkbEventPayloadList`, a class defined in C++
//!
//! # NOTE
...
pub struct HkbEventPayloadList<'a> {
    ...
    /// `0x3d2dbd34`: Unique value of this class.
    #[serde(default = "HkbEventPayloadList::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkbEventPayloadListHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkbEventPayloadListHkParam<'a>>
}
