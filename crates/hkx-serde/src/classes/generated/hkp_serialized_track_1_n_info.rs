//! A Rust structure that implements a serializer/deserializer corresponding to `hkpSerializedTrack1nInfo`, a class defined in C++
//!
//! # NOTE
...
pub struct HkpSerializedTrack1NInfo<'a> {
    ...
    /// `0xf12d48d9`: Unique value of this class.
    #[serde(default = "HkpSerializedTrack1NInfo::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkpSerializedTrack1NInfoHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkpSerializedTrack1NInfoHkParam<'a>>
}
