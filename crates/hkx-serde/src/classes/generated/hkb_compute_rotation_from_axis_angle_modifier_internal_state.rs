...
pub struct HkbComputeRotationFromAxisAngleModifierInternalState<'a> {
    ...
    /// `"hkbComputeRotationFromAxisAngleModifierInternalState"`: Name of this class.
...
impl HkbComputeRotationFromAxisAngleModifierInternalState<'_> {
    /// Return `"hkbComputeRotationFromAxisAngleModifierInternalState"`, which is the name of this class.
    ///
    /// # NOTE
