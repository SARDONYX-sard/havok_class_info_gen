...
pub struct HkpSingleShapeContainer<'a> {
    ...
    /// `"hkpSingleShapeContainer"`: Name of this class.
...
impl HkpSingleShapeContainer<'_> {
    /// Return `"hkpSingleShapeContainer"`, which is the name of this class.
    ///
    /// # NOTE
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("childShape" => ChildShape(Box<HkpShape>)),
}
