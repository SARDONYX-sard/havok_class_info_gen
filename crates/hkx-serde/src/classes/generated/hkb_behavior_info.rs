//! A Rust structure that implements a serializer/deserializer corresponding to `hkbBehaviorInfo`, a class defined in C++
//!
//! # NOTE
...
pub struct HkbBehaviorInfo<'a> {
    ...
    /// `0xf7645395`: Unique value of this class.
    #[serde(default = "HkbBehaviorInfo::signature")]
    #[serde(rename = "@signature", borrow)]
    pub signature: Cow<'a, str>,

    /// The `"hkparam"` tag (C++ field) vector
    #[serde(bound(deserialize = "Vec<HkbBehaviorInfoHkParam<'a>>: Deserialize<'de>"))]
    #[serde(rename = "hkparam")]
    pub hkparams: Vec<HkbBehaviorInfoHkParam<'a>>
}
...
pub enum HkbBehaviorInfoHkParam<'a> {
    ...
    IdToNamePairs(Vec<HkbBehaviorInfoIdToNamePair>),
}
