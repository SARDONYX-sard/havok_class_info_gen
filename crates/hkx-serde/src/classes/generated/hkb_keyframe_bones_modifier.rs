...
pub struct HkbKeyframeBonesModifier<'a> {
    ...
    /// `"hkbKeyframeBonesModifier"`: Name of this class.
...
impl HkbKeyframeBonesModifier<'_> {
    /// Return `"hkbKeyframeBonesModifier"`, which is the name of this class.
    ///
    /// # NOTE
...
pub enum HkbKeyframeBonesModifierHkParam<'a> {
    ...
    KeyframedBonesList(Box<HkbBoneIndexArray>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("keyframedBonesList" => KeyframedBonesList(Box<HkbBoneIndexArray>)),
}
